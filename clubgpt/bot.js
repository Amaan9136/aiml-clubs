...
const userMessage = [
  ...
  /* 8 */["developer number","forgot","password", "message", "You are bad", "contact developer", "report", "there is bug", "bug", "who's behind you", "contact", "phone", "contact", "info", "whatsapp", "wa", "number", "Who is amaan", "amaan", "amaan mk", "mk", "mohammed", "khalander"],
  /* 9 */["instagram", "username", "user", "insta"],
  ...
  /* 12 */["i love you", "love", "love you", "like", "awesome", "great", "cool","feedback","support","link","suggestion","suggest","bug","error","happy", "good", "fun", "wonderful", "fantastic", "cool", "very good", "awesome", "nice", "excellent"],
  /* 13 */["bad", "help", "bored", "tired", "not good", "feeling down", "feeling low", "i am sad", "sad"],
  /* 14 */["What is your purpose?", "Why were you created?", "What can you do?", "Tell me about your capabilities", "club", "What's your main function?"],
  /* 15 */["What's the weather like today?", "Tell me the weather forecast", "Weather today"],
  /* 16 */["How does your language model work?", "created", "language", "Explain your AI technology", "Tell me about your architecture", "how you work", "send your code"],
  /* 17 */["What's the time now?", "What's the current time?", "Tell me the time", "time"],
    /* 18 */["events", "news", "plans", "esports", "game", "planned", "future"],
        /* 19 */["previous", "old", "school visit", "visit", "school"],
        /* 20 */["rifa","amk","paatu"],
        /* 21 */["download","app","apk","aiml","club app"],
];
...
const botReply = [
  ...
  /* 12 */["Try giving feedback 👉<a href='https://forms.gle/yTbcyGANT91698Xs5' target=”_blank”>Click Here</a>"],
  /* 13 */[
  ...
  /* 14 */["My purpose is to manage the club and assist you with events and info. 🎉"],
  /* 15 */["I'm sorry, I cannot provide real-time weather information. You can check a weather website or app for the latest updates. ☀️"],
  /* 16 */["That's a secret only Amaan knows! 🤫"],
  /* 17 */["I don't have access to real-time data, including the current time. You can check the time on your device or ask a voice assistant like Siri or Google Assistant. ⌚"],
 /* 18 */[
...
/* 19 */[
    ...
    "Ah, the school visit! It was a great initiative where all 4 clubs joined forces to create a memorable experience. The teamwork and enthusiasm were truly commendable! 🌟🤝"
        ...
        /* 20 */["4 💝 5","💞","😘","💓💞🥰","he is my boss and hero"],
        /* 21 */["Download Our App 👉<a href='../AI&ML Clubs.apk'>Click Here</a>"],
